...
const BottomBar = ({ activeView, onChangeView }) => {
  return (
    <div
      className="absolute bottom-0 w-full z-[500] bg-[#323232] h-14 flex flex-col items-center mb-0 md:mb-4 md:h-16 md:rounded-3xl md:w-[800px]"
      style={{ boxShadow: '0px -2px 12px rgba(0, 0, 0, 0.3)' }}
    >
      {/* Contenedor del indicador */}
      <div className="relative w-full md:w-[740px] h-1">
        {/* Indicador animado */}
        <motion.div
