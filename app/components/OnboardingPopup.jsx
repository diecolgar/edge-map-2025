  ...
  const steps = [
    {
      ...
      description: (
        <>
          ...
          <span className="font-light mt-2 text-edgeTextSecondary">Move around effortlessly to find booths and key locations</span>
        </>
      ),
    },
    {
      ...
      description: (
        <>
          ...
          <span className="mt-2 text-edgeTextSecondary">Refine results by topic, quickly find booths, and explore sector journeys</span>
        </>
      ),
    },
    {
      ...
      description: (
        <>
          ...
          <span className="mt-2 text-edgeTextSecondary">Dive into detailed information, industry insights, and connections</span>
        </>
      ),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col mb-6 text-gray-800">
